...
var fetch = function fetch() {
  ...
  var options = Array.isArray(fOptions) ? Object.assign.apply(Object, _toConsumableArray(fOptions)) : fOptions;
...
var fetchJson = function fetchJson(_ref) {
  var url = _ref.url,
      ...
      options = _objectWithoutProperties(_ref, ['url', 'payload']);

  return fetch(url, makeFetchOptions(options, { payload: payload }));
};
